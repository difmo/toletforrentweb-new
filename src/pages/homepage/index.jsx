          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold">ToletTorrent</h3>
                  <p className="text-sm text-gray-400">Rent with Confidence</p>
                </div>
              </div>
              <p className="text-gray-300 mb-4 max-w-md">
                Connecting property owners and renters through intelligent matching, transparent processes, and community-driven insights.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                <li><a href="#" className="hover:text-white smooth-transition">Find Properties</a></li>
                <li><a href="#" className="hover:text-white smooth-transition">List Property</a></li>
                <li><a href="#" className="hover:text-white smooth-transition">Owner Dashboard</a></li>
                <li><a href="#" className="hover:text-white smooth-transition">Community Hub</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                ...
                <li><a href="#" className="hover:text-white smooth-transition">Safety Guidelines</a></li>
                <li><a href="#" className="hover:text-white smooth-transition">Legal Resources</a></li>
              </ul>
            </div>
          </div>
